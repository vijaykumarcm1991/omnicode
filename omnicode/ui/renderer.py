...
class TerminalRenderer:
    ...
    def print_help(self):
        ...
        commands = [
            ...
            ("/cost", "Show detailed session token usage and estimated cost"),
            ("/model [name]", "Show or switch active LLM model"),
            ("/provider [name]", "Show or switch provider preset (openai/openrouter/deepseek/groq/ollama)"),
            ...
            ("/history", "List saved session history"),
